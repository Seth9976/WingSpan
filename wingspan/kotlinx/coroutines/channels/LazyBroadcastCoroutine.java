...
final class LazyBroadcastCoroutine extends BroadcastCoroutine {
    ...
    public LazyBroadcastCoroutine(CoroutineContext coroutineContext0, BroadcastChannel broadcastChannel0, Function2 function20) {
    ...
    @Override  // kotlinx.coroutines.channels.BroadcastCoroutine
    public ReceiveChannel openSubscription() {
        ReceiveChannel receiveChannel0 = this.get_channel().openSubscription();
        this.start();
