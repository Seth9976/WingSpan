...
public class ChannelCoroutine extends AbstractCoroutine implements Channel {
    ...
    public void cancel() {
        this.cancelInternal(new JobCancellationException(this.cancellationExceptionMessage(), null, this));
    }
