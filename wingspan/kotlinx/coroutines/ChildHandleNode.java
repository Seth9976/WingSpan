...
public final class ChildHandleNode extends JobCancellingNode implements ChildHandle {
    ...
    public void invoke(Throwable throwable0) {
        ParentJob parentJob0 = this.getJob();
        this.childJob.parentCancelled(parentJob0);
    }
}
