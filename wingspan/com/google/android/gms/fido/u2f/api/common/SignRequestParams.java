...
public class SignRequestParams extends RequestParams {
    ...
    SignRequestParams(Integer integer0, Double double0, Uri uri0, byte[] arr_b, List list0, ChannelIdValue channelIdValue0, String s) {
        this.zza = integer0;
        this.zzb = double0;
        this.zzc = uri0;
        this.zzd = arr_b;
    ...
    @Override
    public int hashCode() {
        return Objects.hashCode(new Object[]{this.zza, this.zzc, this.zzb, this.zze, this.zzf, this.zzg, Arrays.hashCode(this.zzd)});
    }
