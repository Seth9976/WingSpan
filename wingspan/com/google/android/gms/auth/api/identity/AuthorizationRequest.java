...
public class AuthorizationRequest extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    static {
        AuthorizationRequest.CREATOR = new zbd();
    }

    AuthorizationRequest(List list0, String s, boolean z, boolean z1, Account account0, String s1, String s2, boolean z2, Bundle bundle0) {
        Preconditions.checkArgument(list0 != null && !list0.isEmpty(), "requestedScopes cannot be null or empty");
        this.zba = list0;
        this.zbb = s;
        this.zbc = z;
    ...
    @Override
    public int hashCode() {
        return Objects.hashCode(new Object[]{this.zba, this.zbb, Boolean.valueOf(this.zbc), Boolean.valueOf(this.zbh), Boolean.valueOf(this.zbd), this.zbe, this.zbf, this.zbg, this.zbi});
    }
