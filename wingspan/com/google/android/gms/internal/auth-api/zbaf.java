...
public final class zbaf extends GoogleApi implements CredentialSavingClient {
    ...
    public zbaf(Activity activity0, zbh zbh0) {
        super(activity0, zbaf.zbc, zbh0, Settings.DEFAULT_SETTINGS);
        this.zbd = "Jbsedl8W39E1GvPtbhTQ_Q";
    }

    public zbaf(Context context0, zbh zbh0) {
        super(context0, zbaf.zbc, zbh0, Settings.DEFAULT_SETTINGS);
        this.zbd = "2QYaj04Wb3aNViislbIRhg";
    }
