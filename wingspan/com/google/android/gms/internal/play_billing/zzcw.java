...
final class zzcw extends zzbn implements zzdk, zzer, RandomAccess {
    private static final zzcw zza;
    private float[] zzb;
    private int zzc;

    static {
        zzcw.zza = new zzcw(new float[0], 0, false);
    }
    ...
    private zzcw(float[] arr_f, int v, boolean z) {
        super(z);
        this.zzb = arr_f;
        this.zzc = v;
    }
    ...
    public final boolean addAll(Collection collection0) {
        ...
        if(!(collection0 instanceof zzcw)) {
            return super.addAll(collection0);
        }
        int v = ((zzcw)collection0).zzc;
        if(v == 0) {
            return false;
        }
        int v1 = this.zzc;
        ...
        System.arraycopy(((zzcw)collection0).zzb, 0, this.zzb, this.zzc, ((zzcw)collection0).zzc);
        this.zzc = v2;
        ++this.modCount;
        return true;
    }
    ...
    public final boolean equals(Object object0) {
        ...
        if(this.zzc != ((zzcw)object0).zzc) {
            return false;
        }
        float[] arr_f = ((zzcw)object0).zzb;
    ...
    public final zzdk zzd(int v) {
        ...
        return new zzcw(Arrays.copyOf(this.zzb, v), this.zzc, true);
    }
