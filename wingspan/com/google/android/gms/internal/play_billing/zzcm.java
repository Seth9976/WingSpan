...
final class zzcm extends zzbn implements zzdk, zzer, RandomAccess {
    private static final zzcm zza;
    private double[] zzb;
    private int zzc;

    static {
        zzcm.zza = new zzcm(new double[0], 0, false);
    }
    ...
    private zzcm(double[] arr_f, int v, boolean z) {
        super(z);
        this.zzb = arr_f;
        this.zzc = v;
    }
    ...
    public final boolean addAll(Collection collection0) {
        ...
        if(!(collection0 instanceof zzcm)) {
            return super.addAll(collection0);
        }
        int v = ((zzcm)collection0).zzc;
        if(v == 0) {
            return false;
        }
        int v1 = this.zzc;
        ...
        System.arraycopy(((zzcm)collection0).zzb, 0, this.zzb, this.zzc, ((zzcm)collection0).zzc);
        this.zzc = v2;
        ++this.modCount;
        return true;
    }
    ...
    public final boolean equals(Object object0) {
        ...
        if(this.zzc != ((zzcm)object0).zzc) {
            return false;
        }
        double[] arr_f = ((zzcm)object0).zzb;
    ...
    public final zzdk zzd(int v) {
        ...
        return new zzcm(Arrays.copyOf(this.zzb, v), this.zzc, true);
    }
