...
final class zzbr extends zzbn implements zzdk, zzer, RandomAccess {
    private static final zzbr zza;
    private boolean[] zzb;
    private int zzc;

    static {
        zzbr.zza = new zzbr(new boolean[0], 0, false);
    }
    ...
    private zzbr(boolean[] arr_z, int v, boolean z) {
        super(z);
        this.zzb = arr_z;
        this.zzc = v;
    }
    ...
    public final boolean addAll(Collection collection0) {
        ...
        if(!(collection0 instanceof zzbr)) {
            return super.addAll(collection0);
        }
        int v = ((zzbr)collection0).zzc;
        if(v == 0) {
            return false;
        }
        int v1 = this.zzc;
        ...
        System.arraycopy(((zzbr)collection0).zzb, 0, this.zzb, this.zzc, ((zzbr)collection0).zzc);
        this.zzc = v2;
        ++this.modCount;
        return true;
    }
    ...
    public final boolean equals(Object object0) {
        ...
        if(this.zzc != ((zzbr)object0).zzc) {
            return false;
        }
        boolean[] arr_z = ((zzbr)object0).zzb;
    ...
    public final int hashCode() {
        int v1 = 1;
        for(int v = 0; v < this.zzc; ++v) {
            v1 = v1 * 0x1F + zzdl.zza(this.zzb[v]);
        }
        return v1;
    }
    ...
    public final zzdk zzd(int v) {
        ...
        return new zzbr(Arrays.copyOf(this.zzb, v), this.zzc, true);
    }
