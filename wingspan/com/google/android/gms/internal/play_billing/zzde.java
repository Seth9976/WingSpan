...
final class zzde extends zzbn implements zzdi, zzer, RandomAccess {
    private static final zzde zza;
    private int[] zzb;
    private int zzc;

    static {
        zzde.zza = new zzde(new int[0], 0, false);
    }
    ...
    private zzde(int[] arr_v, int v, boolean z) {
        super(z);
        this.zzb = arr_v;
        this.zzc = v;
    }
    ...
    public final boolean addAll(Collection collection0) {
        ...
        if(!(collection0 instanceof zzde)) {
            return super.addAll(collection0);
        }
        int v = ((zzde)collection0).zzc;
        if(v == 0) {
            return false;
        }
        int v1 = this.zzc;
        ...
        System.arraycopy(((zzde)collection0).zzb, 0, this.zzb, this.zzc, ((zzde)collection0).zzc);
        this.zzc = v2;
        ++this.modCount;
        return true;
    }
    ...
    public final boolean equals(Object object0) {
        ...
        if(this.zzc != ((zzde)object0).zzc) {
            return false;
        }
        int[] arr_v = ((zzde)object0).zzb;
    ...
    public final zzdi zzg(int v) {
        if(v < this.zzc) {
            throw new IllegalArgumentException();
        }
        return new zzde(Arrays.copyOf(this.zzb, v), this.zzc, true);
    }
