...
final class zzdz extends zzbn implements zzdk, zzer, RandomAccess {
    private static final zzdz zza;
    private long[] zzb;
    private int zzc;

    static {
        zzdz.zza = new zzdz(new long[0], 0, false);
    }
    ...
    private zzdz(long[] arr_v, int v, boolean z) {
        super(z);
        this.zzb = arr_v;
        this.zzc = v;
    }
    ...
    public final boolean addAll(Collection collection0) {
        ...
        if(!(collection0 instanceof zzdz)) {
            return super.addAll(collection0);
        }
        int v = ((zzdz)collection0).zzc;
        if(v == 0) {
            return false;
        }
        int v1 = this.zzc;
        ...
        System.arraycopy(((zzdz)collection0).zzb, 0, this.zzb, this.zzc, ((zzdz)collection0).zzc);
        this.zzc = v2;
        ++this.modCount;
        return true;
    }
    ...
    public final boolean equals(Object object0) {
        ...
        if(!(object0 instanceof zzdz)) {
            return super.equals(object0);
        }
        if(this.zzc != ((zzdz)object0).zzc) {
            return false;
        }
        long[] arr_v = ((zzdz)object0).zzb;
    ...
    public final zzdk zzd(int v) {
        ...
        return new zzdz(Arrays.copyOf(this.zzb, v), this.zzc, true);
    }
