...
final class zzem {
    ...
    static String zza(zzek zzek0, String s) {
        StringBuilder stringBuilder0 = new StringBuilder();
        stringBuilder0.append("# ");
        stringBuilder0.append(s);
        zzem.zzd(zzek0, stringBuilder0, 0);
    ...
    static void zzb(StringBuilder stringBuilder0, int v, String s, Object object0) {
        if(object0 instanceof List) {
            for(Object object1: ((List)object0)) {
                zzem.zzb(stringBuilder0, v, s, object1);
            }
            return;
        }
        if(object0 instanceof Map) {
            for(Object object2: ((Map)object0).entrySet()) {
                zzem.zzb(stringBuilder0, v, s, ((Map.Entry)object2));
            }
            return;
        }
        stringBuilder0.append('\n');
        zzem.zzc(v, stringBuilder0);
        if(!s.isEmpty()) {
        ...
        if(object0 instanceof String) {
            stringBuilder0.append(": \"");
            stringBuilder0.append(zzfk.zza(new zzbz(((String)object0).getBytes(zzdl.zzb))));
            stringBuilder0.append('\"');
            return;
        }
        if(object0 instanceof zzcc) {
            stringBuilder0.append(": \"");
            stringBuilder0.append(zzfk.zza(((zzcc)object0)));
            stringBuilder0.append('\"');
            return;
        }
        if(object0 instanceof zzdd) {
            stringBuilder0.append(" {");
            zzem.zzd(((zzdd)object0), stringBuilder0, v + 2);
            stringBuilder0.append("\n");
            zzem.zzc(v, stringBuilder0);
            stringBuilder0.append("}");
            return;
        ...
        if(object0 instanceof Map.Entry) {
            stringBuilder0.append(" {");
            zzem.zzb(stringBuilder0, v + 2, "key", ((Map.Entry)object0).getKey());
            zzem.zzb(stringBuilder0, v + 2, "value", ((Map.Entry)object0).getValue());
            stringBuilder0.append("\n");
            zzem.zzc(v, stringBuilder0);
            stringBuilder0.append("}");
            return;
    ...
    private static void zzc(int v, StringBuilder stringBuilder0) {
        while(true) {
            ...
            stringBuilder0.append(zzem.zza, 0, v1);
            v -= v1;
        }
    }

    private static void zzd(zzek zzek0, StringBuilder stringBuilder0, int v) {
        boolean z;
        HashSet hashSet0 = new HashSet();
        HashMap hashMap0 = new HashMap();
        TreeMap treeMap0 = new TreeMap();
        Method[] arr_method = zzek0.getClass().getDeclaredMethods();
        ...
        for(Object object0: treeMap0.entrySet()) {
            ...
            if(s.endsWith("List") && !s.endsWith("OrBuilderList") && !s.equals("List")) {
                ...
                if(method1 != null && method1.getReturnType().equals(List.class)) {
                    zzem.zzb(stringBuilder0, v, s.substring(0, s.length() - 4), zzdd.zzp(method1, zzek0, new Object[0]));
                    continue;
                }
            }
            if(s.endsWith("Map") && !s.equals("Map")) {
                ...
                if(method2 != null && method2.getReturnType().equals(Map.class) && !method2.isAnnotationPresent(Deprecated.class) && Modifier.isPublic(method2.getModifiers())) {
                    zzem.zzb(stringBuilder0, v, s.substring(0, s.length() - 3), zzdd.zzp(method2, zzek0, new Object[0]));
                    continue;
                }
            }
            if(hashSet0.contains("set" + s) && (!s.endsWith("Bytes") || !treeMap0.containsKey("get" + s.substring(0, s.length() - 5)))) {
                ...
                if(method3 != null) {
                    Object object1 = zzdd.zzp(method3, zzek0, new Object[0]);
                    if(method4 == null) {
                        if(object1 instanceof Boolean) {
                            ...
                            if(object1 instanceof zzcc) {
                                z = object1.equals(zzcc.zzb);
                            label_57:
                                if(z) {
                                    continue;
                                }
                            }
                            else if(object1 instanceof zzek) {
                                if(object1 == ((zzek)object1).zzf()) {
                                    continue;
                                }
                            }
                    ...
                    label_64:
                        if(((Boolean)zzdd.zzp(method4, zzek0, new Object[0])).booleanValue()) {
                            goto label_65;
                        }
                        continue;
                    }
        ...
        if(!(zzek0 instanceof zzda)) {
            zzfn zzfn0 = ((zzdd)zzek0).zzc;
            if(zzfn0 != null) {
                zzfn0.zzi(stringBuilder0, v);
            }
            return;
        }
        zzda zzda0 = (zzda)zzek0;
        throw null;
    }
}
