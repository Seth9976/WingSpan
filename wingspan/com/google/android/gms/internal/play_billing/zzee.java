...
public final class zzee extends LinkedHashMap {
    ...
    public final int hashCode() {
        ...
        for(Object object0: this.entrySet()) {
            int v1 = zzee.zzf(((Map.Entry)object0).getKey());
            v += zzee.zzf(((Map.Entry)object0).getValue()) ^ v1;
        }
        return v;
    }
    ...
    public final zzee zzb() {
        return this.isEmpty() ? new zzee() : new zzee(this);
    }
    ...
    public final void zzd(zzee zzee0) {
        this.zzg();
        if(!zzee0.isEmpty()) {
            this.putAll(zzee0);
        }
    ...
    private static int zzf(Object object0) {
        if(object0 instanceof byte[]) {
            ...
            int v1 = zzdl.zzb(v, ((byte[])object0), 0, v);
            return v1 == 0 ? 1 : v1;
        }
        if(object0 instanceof zzdf) {
