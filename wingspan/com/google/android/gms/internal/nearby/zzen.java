...
public final class zzen extends AbstractSafeParcelable {
    ...
    static {
        zzen.CREATOR = new zzeo();
    }

    private zzen() {
    }

    zzen(String s, int v, byte[] arr_b) {
        this.zzat = s;
        this.statusCode = v;
        this.zzau = arr_b;
    }
    ...
    public final boolean equals(Object object0) {
        return this == object0 ? true : object0 instanceof zzen && Objects.equal(this.zzat, ((zzen)object0).zzat) && Objects.equal(this.statusCode, ((zzen)object0).statusCode) && Arrays.equals(this.zzau, ((zzen)object0).zzau);
    }
