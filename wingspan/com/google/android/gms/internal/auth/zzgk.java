...
final class zzgk {
    ...
    static {
        ...
        if(class1 != null) {
            try {
                zzgz0 = (zzgz)class1.getConstructor().newInstance();
            }
            catch(Throwable unused_ex) {
            }
        }
    ...
    static Object zzc(Object object0, int v, int v1, Object object1, zzgz zzgz0) {
        if(object1 == null) {
    ...
    static void zzd(zzgz zzgz0, Object object0, Object object1) {
