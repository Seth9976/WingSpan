...
public abstract class GoogleApiClient {
    ...
    public static final class Builder {
        ...
        public Builder(Context context0) {
            ...
            this.zaf = "com.MonsterCouch.Wingspan";
        ...
        public GoogleApiClient build() {
            ...
            for(Object object0: this.zaj.keySet()) {
                ...
                arrayList0.add(zat0);
                Object object2 = Preconditions.checkNotNull(((Api)object0).zaa());
                Client api$Client0 = ((AbstractClientBuilder)object2).buildClient(this.zai, this.zan, clientSettings0, object1, zat0, zat0);
                arrayMap1.put(((Api)object0).zab(), api$Client0);
                if(((AbstractClientBuilder)object2).getPriority() == 1) {
                    z = object1 != null;
                }
            ...
            if(api0 != null) {
                if(z) {
                    throw new IllegalStateException("With using " + api0.zad() + ", GamesOptions can only be specified within GoogleSignInOptions.Builder");
                }
