...
public class FirebaseError {
    ...
    public static final int ERROR_INTERNAL_ERROR = 0x445B;
    public static final int ERROR_INVALID_API_KEY = 0x427F;
    ...
    public static final int ERROR_NO_SIGNED_IN_USER = 0x4457;
    ...
    public static final int ERROR_USER_MISMATCH = 0x4280;
