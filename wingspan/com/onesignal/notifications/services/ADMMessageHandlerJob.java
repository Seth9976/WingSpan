...
public final class ADMMessageHandlerJob extends ADMMessageHandlerJobBase {
    ...
    protected void onRegistered(Context context0, String s) {
        ...
        ThreadUtilsKt.suspendifyOnThread$default(0, new Function1(s, null) {
            ...
            public final Continuation create(Continuation continuation0) {
                return new com.onesignal.notifications.services.ADMMessageHandlerJob.onRegistered.1(this.$registerer, this.$newRegistrationId, continuation0);
            }
            ...
            public final Object invoke(Continuation continuation0) {
                return ((com.onesignal.notifications.services.ADMMessageHandlerJob.onRegistered.1)this.create(continuation0)).invokeSuspend(Unit.INSTANCE);
            }
    ...
    protected void onRegistrationError(Context context0, String s) {
        ...
        ThreadUtilsKt.suspendifyOnThread$default(0, new Function1(null) {
            ...
            @Override  // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation create(Continuation continuation0) {
                return new com.onesignal.notifications.services.ADMMessageHandlerJob.onRegistrationError.1(this.$registerer, continuation0);
            }
            ...
            public final Object invoke(Continuation continuation0) {
                return ((com.onesignal.notifications.services.ADMMessageHandlerJob.onRegistrationError.1)this.create(continuation0)).invokeSuspend(Unit.INSTANCE);
            }
