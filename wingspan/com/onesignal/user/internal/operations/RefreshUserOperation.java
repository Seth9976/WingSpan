...
public final class RefreshUserOperation extends Operation {
    ...
    public RefreshUserOperation(String s, String s1) {
    ...
    public String getCreateComparisonKey() {
        return this.getAppId() + ".User." + this.getOnesignalId() + ".Refresh";
    }
