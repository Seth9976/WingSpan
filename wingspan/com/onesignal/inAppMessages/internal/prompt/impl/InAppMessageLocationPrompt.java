...
public final class InAppMessageLocationPrompt extends InAppMessagePrompt {
    ...
    public InAppMessageLocationPrompt(ILocationManager iLocationManager0) {
    ...
    public Object handlePrompt(Continuation continuation0) {
        com.onesignal.inAppMessages.internal.prompt.impl.InAppMessageLocationPrompt.handlePrompt.1 inAppMessageLocationPrompt$handlePrompt$10;
        if(continuation0 instanceof com.onesignal.inAppMessages.internal.prompt.impl.InAppMessageLocationPrompt.handlePrompt.1) {
            inAppMessageLocationPrompt$handlePrompt$10 = (com.onesignal.inAppMessages.internal.prompt.impl.InAppMessageLocationPrompt.handlePrompt.1)continuation0;
            if((inAppMessageLocationPrompt$handlePrompt$10.label & 0x80000000) == 0) {
                inAppMessageLocationPrompt$handlePrompt$10 = new ContinuationImpl(/*ERROR_MISSING_ARG_1/*) {
                    int label;
                    Object result;
                ...
                inAppMessageLocationPrompt$handlePrompt$10.label ^= 0x80000000;
            }
        }
        else {
            inAppMessageLocationPrompt$handlePrompt$10 = new ContinuationImpl(/*ERROR_MISSING_ARG_1/*) {
        ...
        Object object0 = inAppMessageLocationPrompt$handlePrompt$10.result;
        Object object1 = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        switch(inAppMessageLocationPrompt$handlePrompt$10.label) {
            case 0: {
                ResultKt.throwOnFailure(object0);
                inAppMessageLocationPrompt$handlePrompt$10.label = 1;
                object0 = this._locationManager.requestPermission(inAppMessageLocationPrompt$handlePrompt$10);
                if(object0 == object1) {
                    return object1;
                }
