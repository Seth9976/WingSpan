...
if ((sub_45be5c(arg1, &var_58, &var_68, 1, "androidx/loader/app/services/", 0x452470, 0x452601) & 1)
    ...
    if (((*(*arg1 + 0x418))(arg1, var_58, var_68, &var_50) & 0x80000000) == 0
        ...
        if ((sub_45bc9c(arg1, &var_60, "android/content/Context") & 1) != 0)
            result = 0
        else
            x2_2 = var_60
        label_473e74:
            ...
            if ((sub_45bc08(arg1, x0, x2_2, "android/content/Context") & 1) != 0)
                ...
                if ((sub_45be5c(arg1, &var_60, &var_70, 0, "android/content/Context", 
                        "getPackageManager", "()Landroid/content/pm/PackageManager;") & 1) != 0)
                    result = 0
                else
                    x2_3 = var_70
                label_473f20:
