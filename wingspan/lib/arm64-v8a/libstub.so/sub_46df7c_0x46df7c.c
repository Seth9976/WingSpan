...
int64_t var_48
int32_t result =
    sub_45be5c(arg1, &var_48, &var_58, 1, "androidx/loader/app/services/", 0x4529be, 0x452601)
...
if ((result & 1) == 0)
    ...
    if (x0_3 s>= 1 && (result & 0xff) == 0)
        ...
        result = sub_45bc9c(arg1, &var_50, "java/lang/Thread")
        
        if ((result & 1) == 0)
            x2_2 = var_50
        label_46e084:
            result = sub_45bc08(arg1, x0, x2_2, "java/lang/Thread")
                ...
                if ((result & 0xff) == 0)
                    if (x0 == 0)
                        ...
                        if (x2_3 != 0)
                            ...
                            result = sub_45be5c(arg1, &var_50, &var_60, 0, "java/lang/Thread", 
                                "start", "()V")
