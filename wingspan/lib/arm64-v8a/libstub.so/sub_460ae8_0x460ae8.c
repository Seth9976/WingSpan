    ...
    if ((*(*arg1 + 0x418))(arg1, var_58, var_70, &var_50) s>= 1
        ...
        label_460bf8:
            ...
            if ((sub_45bc08(arg1, x0, x2_2, "android/app/AlertDialog$Builder") & 1) != 0)
                ...
                if ((sub_45bc9c(arg1, &var_68, "android/view/View") & 1) != 0)
                    result = 0
                else
                    x2_3 = var_68
                label_460c7c:
                    
                    if ((sub_45bc08(arg1, x0_2, x2_3, "android/view/View") & 1) != 0)
                        result = 0
                    else if (zx.d((*(*arg1 + 0x720))(arg1)) != 0)
                        result = 0
                    else if (x0 == 0)
                        ...
                        if ((sub_45be5c(arg1, &var_60, &var_78, 0, 
                                "android/app/AlertDialog$Builder", "setView", 
                                "(Landroid/view/View;)Landroid/app/AlertDialog$Builder;") & 1) != 0)
                            result = 0
                        else
                            x2_4 = var_78
                        label_460cdc:
