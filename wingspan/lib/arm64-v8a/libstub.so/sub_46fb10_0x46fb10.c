...
if ((sub_45be5c(arg1, &var_58, &var_70, 1, "androidx/loader/app/services/", 0x451d55, 0x452601) & 1)
    ...
    if (((*(*arg1 + 0x418))(arg1, var_58, var_70, &var_50) & 0x80000000) == 0
        ...
        if ((sub_45bc9c(arg1, &var_60, "androidx/loader/app/services/i") & 1) != 0)
            result = 0
        else
            x2_2 = var_60
        label_46fbfc:
            
            if ((sub_45bc08(arg1, x0, x2_2, "androidx/loader/app/services/i") & 1) != 0)
                result = 0
                ...
                if ((sub_45c03c(arg1, &var_60, &var_68, 0, "androidx/loader/app/services/i", "a", 
