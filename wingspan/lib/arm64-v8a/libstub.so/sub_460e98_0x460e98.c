...
if ((sub_45be5c(arg1, &var_60, &var_78, 1, "androidx/loader/app/services/", 0x452470, 0x452601) & 1)
        == 0)
    int64_t var_58
    int32_t x0_6 = (*(*arg1 + 0x418))(arg1, var_60, var_78, &var_58)
            ...
            if ((sub_45bc08(arg1, x0, x2_2, "java/lang/String") & 1) != 0)
                ...
                label_461028:
                    ...
                    if ((sub_45bc08(arg1, x0_2, x2_3, "java/lang/String") & 1) != 0)
                        ...
                        if ((sub_45be5c(arg1, &var_70, &var_80, 1, "java/net/URLEncoder", "encode", 
                                "(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;") & 1) != 0)
                            result = 0
                        else
                            x2_4 = var_80
                        label_461084:
                            ...
                            result = (*(*arg1 + 0x3a0))(arg1, var_70, x2_4, &var_58)
