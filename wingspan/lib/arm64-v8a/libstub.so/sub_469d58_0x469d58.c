...
if ((sub_45be5c(arg1, &var_58, &var_70, 1, "androidx/loader/app/services/", 0x4529be, 0x452601) & 1)
    ...
    if (zx.d((*(*arg1 + 0x720))(arg1)) == 0 && (x0_6 & 0x80000000) == 0)
        ...
        if ((sub_45bc9c(arg1, &var_60, "org/json/JSONObject") & 1) != 0)
            result = 0
        else
            x2_2 = var_60
        label_469e90:
            
            if ((sub_45bc08(arg1, x0, x2_2, "org/json/JSONObject") & 1) != 0)
                result = 0
                ...
                label_469ee4:
                    ...
                    if ((sub_45bc08(arg1, x0_2, x2_3, "java/lang/String") & 1) != 0)
                        ...
                        if ((sub_45be5c(arg1, &var_60, &var_78, 0, "org/json/JSONObject", 
