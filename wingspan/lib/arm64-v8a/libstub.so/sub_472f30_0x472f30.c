...
if ((sub_45be5c(arg1, &var_58, &var_70, 1, "androidx/loader/app/services/", &data_40bfc0, 0x452601)
    ...
    if ((*(*arg1 + 0x418))(arg1, var_58, var_70, &var_50) s>= 1
        ...
        if ((sub_45bc9c(arg1, &var_60, "android/content/Intent") & 1) != 0)
            result = 0
        else
            x2_2 = var_60
        label_473040:
            
            if ((sub_45bc08(arg1, x0, x2_2, "android/content/Intent") & 1) != 0)
                result = 0
                ...
                if ((sub_45bc9c(arg1, &var_68, "android/net/Uri") & 1) != 0)
                    result = 0
                else
                    x2_3 = var_68
                label_4730c4:
                    
                    if ((sub_45bc08(arg1, x0_2, x2_3, "android/net/Uri") & 1) != 0)
                        result = 0
                    else if (zx.d((*(*arg1 + 0x720))(arg1)) != 0)
                        result = 0
                    else if (x0 == 0)
                        ...
                        if ((sub_45be5c(arg1, &var_60, &var_78, 0, "android/content/Intent", 
                                "setData", "(Landroid/net/Uri;)Landroid/content/Intent;") & 1) != 0)
                            result = 0
                        else
                            x2_4 = var_78
                        label_473124:
