...
if ((result & 1) == 0)
    ...
    if ((x0_5 & 0x80000000) == 0 && (result & 0xff) == 0)
        ...
        result = sub_45bc9c(arg1, &var_60, "android/graphics/drawable/GradientDrawable")
        
        if ((result & 1) == 0)
            x2_2 = var_60
        label_468eb8:
            result = sub_45bc08(arg1, x0, x2_2, "android/graphics/drawable/GradientDrawable")
            ...
            if ((result & 1) == 0)
                ...
                if ((result & 0xff) == 0)
                    ...
                    result = sub_45bc9c(arg1, &var_68, "[F")
                    
                    if ((result & 1) == 0)
                        x2_3 = var_68
                    label_468f0c:
                        result = sub_45bc08(arg1, x0_2, x2_3, "[F")
