...
if (x0 == 0)
    ...
    int64_t var_68
    int64_t var_48
    result = sub_45be5c(arg1, &var_48, &var_68, 0, "android/app/Activity", "onTrimMemory", "(I)V")
    ...
    if ((result & 1) == 0)
        ...
        if (arg3 == 0xf && (result & 0xff) == 0)
            ...
            if ((result & 1) == 0)
                x2_2 = var_60
            label_490794:
                int64_t x0_6 = (*(*arg1 + 0x2f8))(arg1, x0, x2_2)
                result = (*(*arg1 + 0x720))(arg1)
                ...
                if ((result & 0xff) == 0)
                    if (x0_6 == 0)
                        ...
                        if (x2_4 != 0)
                            (*(*arg1 + 0x1f8))(arg1, x0_6, x2_4, &var_40)
                            result = (*(*arg1 + 0x720))(arg1)
                        else
                            int64_t var_58
                            result = sub_45be5c(arg1, &var_58, &var_70, 0, 
                                "com/unity3d/player/UnityPlayer", "lowMemory", "()V")
