...
if ((sub_45be5c(arg1, &var_48, &var_60, 1, "androidx/loader/app/services/", &data_40bfc0, 0x452601)
    ...
    if (zx.d((*(*arg1 + 0x720))(arg1)) == 0 && (x0_4 & 0x80000000) == 0)
        ...
        if ((sub_45bc9c(arg1, &var_50, "java/io/InputStream") & 1) != 0)
            result = 0
        else
            x2_2 = var_50
        label_4738d4:
            ...
            if ((sub_45bc08(arg1, x0, x2_2, "java/io/InputStream") & 1) != 0)
                ...
                if ((sub_45be5c(arg1, &var_58, &var_68, 1, "androidx/loader/app/services/c", "a", 
                        "(Ljava/io/InputStream;)Ljava/lang/String;") & 1) != 0)
                    result = 0
                else
                    x2_3 = var_68
                label_473930:
