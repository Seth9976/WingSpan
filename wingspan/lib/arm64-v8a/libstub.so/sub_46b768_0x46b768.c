...
if ((result & 1) == 0)
    ...
    if ((x0_3 & 0x80000000) == 0 && (result & 0xff) == 0)
        ...
        result = sub_45bc9c(arg1, &var_50, "android/widget/Toast")
        
        if ((result & 1) == 0)
            x2_2 = var_50
        label_46b86c:
            result = sub_45bc08(arg1, x0, x2_2, "android/widget/Toast")
                ...
                if ((result & 0xff) == 0)
                    if (x0 == 0)
                        ...
                        if (x2_3 != 0)
                            ...
                            result = sub_45be5c(arg1, &var_50, &var_60, 0, "android/widget/Toast", 
                                "show", "()V")
