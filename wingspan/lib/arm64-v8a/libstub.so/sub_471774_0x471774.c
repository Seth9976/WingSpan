...
if ((sub_45be5c(arg1, &var_48, &var_60, 1, "androidx/loader/app/services/", 0x4529be, 0x452601) & 1)
    ...
    if (zx.d((*(*arg1 + 0x720))(arg1)) == 0 && x0_4 s>= 1)
        ...
        if ((sub_45bc9c(arg1, &var_50, "java/lang/Throwable") & 1) != 0)
            result = 0
        else
            x2_2 = var_50
        label_47188c:
            
            if ((sub_45bc08(arg1, x0, x2_2, "java/lang/Throwable") & 1) != 0)
                result = 0
                ...
                if ((sub_45be5c(arg1, &var_58, &var_68, 1, "android/util/Log", 
                        "getStackTraceString", "(Ljava/lang/Throwable;)Ljava/lang/String;") & 1) != 0)
                    result = 0
                else
                    x2_3 = var_68
                label_4718e8:
