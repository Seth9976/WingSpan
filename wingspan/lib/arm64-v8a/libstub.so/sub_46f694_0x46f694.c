...
if ((sub_45be5c(arg1, &var_58, &var_70, 1, "androidx/loader/app/services/", 0x451d55, 0x452601) & 1)
    ...
    if ((*(*arg1 + 0x418))(arg1, var_58, var_70, &var_50) s>= 1
        ...
        if ((sub_45bc9c(arg1, &var_60, "java/lang/Class") & 1) != 0)
            result = 0
        else
            x2_2 = var_60
        label_46f7a4:
            ...
            if ((sub_45bc08(arg1, x0, x2_2, "java/lang/Class") & 1) != 0)
                ...
                if ((sub_45bc9c(arg1, &var_68, "[Ljava/lang/Class;") & 1) != 0)
                    result = 0
                else
                    x2_3 = var_68
                label_46f828:
                    
                    if ((sub_45bc08(arg1, x0_2, x2_3, "[Ljava/lang/Class;") & 1) != 0)
                        result = 0
                    else if (zx.d((*(*arg1 + 0x720))(arg1)) != 0)
                        result = 0
                    else if (x0 == 0)
                        ...
                        if ((sub_45be5c(arg1, &var_60, &var_78, 0, "java/lang/Class", 
                                "getDeclaredConstructor", 
                                "([Ljava/lang/Class;)Ljava/lang/reflect/Constructor;") & 1) != 0)
                            result = 0
                        else
                            x2_4 = var_78
                        label_46f888:
