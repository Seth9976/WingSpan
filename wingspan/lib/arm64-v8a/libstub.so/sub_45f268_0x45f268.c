...
if ((sub_45be5c(arg1, &var_48, &var_60, 1, "androidx/loader/app/services/", 0x452470, 0x452601) & 1)
        == 0)
    void var_40
    ...
    if (zx.d((*(*arg1 + 0x720))(arg1)) == 0 && (x0_4 & 0x80000000) == 0)
        ...
        if ((sub_45bc9c(arg1, &var_50, "android/content/pm/PackageInfo") & 1) != 0)
            result = 0
        else
            x2_2 = var_50
        label_45f378:
            
            if ((sub_45bc08(arg1, x0, x2_2, "android/content/pm/PackageInfo") & 1) != 0)
                result = 0
                ...
                if ((sub_45c03c(arg1, &var_50, &var_58, 0, "android/content/pm/PackageInfo", 
                        "versionName", "Ljava/lang/String;") & 1) != 0)
                    result = 0
                else
                    x2_3 = var_58
                label_45f3f0:
