...
int64_t var_60
int32_t result =
    sub_45be5c(arg1, &var_60, &var_80, 1, "androidx/loader/app/services/", 0x452470, 0x452601)
        ...
        label_46a528:
            ...
            if ((result & 1) == 0)
                ...
                if ((result & 0xff) == 0)
                    ...
                    result = sub_45bc9c(arg1, &var_70, "java/lang/Throwable")
                        ...
                        if ((result & 1) == 0)
                            ...
                            if ((result & 0xff) == 0)
                                ...
                                result = sub_45be5c(arg1, &var_78, &var_88, 1, 
                                    "androidx/loader/app/services/l$a", "e", 
