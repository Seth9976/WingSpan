...
if ((sub_45be5c(arg1, &var_60, &var_80, 1, "androidx/loader/app/services/", &data_40bfc0, 0x452601)
        & 1) == 0)
    result = 0
    int64_t var_58
    ...
    if ((*(*arg1 + 0x418))(arg1, var_60, var_80, &var_58) s>= 1
        ...
        if ((sub_45bc9c(arg1, &var_68, "java/lang/Class") & 1) != 0)
            result = 0
        else
            x2_2 = var_68
        label_4602ac:
            
            if ((sub_45bc08(arg1, x0, x2_2, "java/lang/Class") & 1) != 0)
                result = 0
                ...
                label_460330:
                    ...
                    if ((sub_45bc08(arg1, x0_2, x2_3, "java/lang/String") & 1) != 0)
                        ...
                        if ((sub_45bc9c(arg1, &var_78, "[Ljava/lang/Class;") & 1) != 0)
                            result = 0
                        else
                            x2_4 = var_78
                        label_460384:
                            
                            if ((sub_45bc08(arg1, x0_4, x2_4, "[Ljava/lang/Class;") & 1) != 0)
                                result = 0
                            else if (zx.d((*(*arg1 + 0x720))(arg1)) != 0)
                                result = 0
                            else if (x0 == 0)
                                ...
                                if ((sub_45be5c(arg1, &var_68, &var_88, 0, "java/lang/Class", 
                                        "getMethod", 
                                ...
                                label_4603e4:
                                    ...
                                    result = (*(*arg1 + 0x120))(arg1, x0, x2_5, &var_58)
