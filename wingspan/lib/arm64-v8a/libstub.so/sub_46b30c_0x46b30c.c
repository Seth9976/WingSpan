...
if ((result & 1) == 0)
    ...
    if ((x0_5 & 0x80000000) == 0 && (result & 0xff) == 0)
        ...
        result = sub_45bc9c(arg1, &var_60, "android/content/Context")
        ...
        label_46b438:
            ...
            if ((result & 1) == 0)
                ...
                if ((result & 0xff) == 0)
                    ...
                    result = sub_45bc9c(arg1, &var_68, "android/content/Intent")
                    
                    if ((result & 1) == 0)
                        x2_3 = var_68
                    label_46b48c:
                        result = sub_45bc08(arg1, x0_2, x2_3, "android/content/Intent")
