...
if ((result & 1) == 0)
    ...
    if (x0_5 s>= 1 && (result & 0xff) == 0)
        ...
        result = sub_45bc9c(arg1, &var_60, "android/widget/ImageView")
        
        if ((result & 1) == 0)
            x2_2 = var_60
        label_45fc74:
            result = sub_45bc08(arg1, x0, x2_2, "android/widget/ImageView")
            ...
            if ((result & 1) == 0)
                ...
                if ((result & 0xff) == 0)
                    ...
                    result = sub_45bc9c(arg1, &var_68, "android/widget/ImageView$ScaleType")
                    
                    if ((result & 1) == 0)
                        x2_3 = var_68
                    label_45fcc8:
                        result = sub_45bc08(arg1, x0_2, x2_3, "android/widget/ImageView$ScaleType")
