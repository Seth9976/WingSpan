...
if ((sub_45be5c(arg1, &var_48, &var_58, 1, "androidx/loader/app/services/", 0x4529be, 0x452601) & 1)
    ...
    if (zx.d((*(*arg1 + 0x720))(arg1)) == 0 && (x0_4 & 0x80000000) == 0)
        ...
        if ((sub_45bc9c(arg1, &var_50, "java/io/ByteArrayOutputStream") & 1) != 0)
            result = 0
        else
            x2_2 = var_50
        label_46a71c:
            
            if ((sub_45bc08(arg1, x0, x2_2, "java/io/ByteArrayOutputStream") & 1) != 0)
                result = 0
                ...
                if ((sub_45be5c(arg1, &var_50, &var_60, 0, "java/io/ByteArrayOutputStream", 
