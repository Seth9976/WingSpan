...
int64_t var_68
int64_t var_50
int32_t result = sub_45be5c(arg1, &var_50, &var_68, 1, "androidx/loader/app/services/", 0x4520b9, 
...
if ((result & 1) == 0)
    ...
    if ((result & 0xff) == 0)
        ...
        result = sub_45be5c(arg1, &var_58, &var_70, 1, "androidx/loader/app/services/", 
            &data_40c226, "(Ljava/lang/Object;)Lorg/json/JSONObject;")
        ...
        label_4761c4:
            ...
            if ((result & 0xff) == 0)
                ...
                result = sub_45be5c(arg1, &var_60, &var_78, 1, "androidx/loader/app/services/", 
                    0x4528b8, "(Ljava/lang/Object;Ljava/lang/Object;)V")
