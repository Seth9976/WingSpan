...
int64_t var_48
int32_t result =
    sub_45be5c(arg1, &var_48, &var_58, 1, "androidx/loader/app/services/", &data_40bfc0, 0x452601)
...
if ((result & 1) == 0)
    ...
    if ((x0_3 & 0x80000000) == 0 && (result & 0xff) == 0)
        ...
        result = sub_45bc9c(arg1, &var_50, "androidx/loader/app/services/b")
        
        if ((result & 1) == 0)
            x2_2 = var_50
        label_463b7c:
            result = sub_45bc08(arg1, x0, x2_2, "androidx/loader/app/services/b")
                ...
                if ((result & 0xff) == 0)
                    if (x0 == 0)
                        ...
                        if (x2_3 != 0)
                            ...
                            result = sub_45be5c(arg1, &var_50, &var_60, 0, 
                                "androidx/loader/app/services/b", "b", "()V")
