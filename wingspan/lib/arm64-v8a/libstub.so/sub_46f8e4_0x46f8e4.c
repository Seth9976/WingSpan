...
if ((sub_45be5c(arg1, &var_60, &var_80, 1, "androidx/loader/app/services/", 0x452470, 0x452601) & 1)
        == 0)
    int64_t var_58
    ...
    if (zx.d((*(*arg1 + 0x720))(arg1)) == 0 && (x0_6 & 0x80000000) == 0)
        ...
        label_46fa20:
            ...
            if ((sub_45bc08(arg1, x0, x2_2, "java/lang/String") & 1) != 0)
                ...
                if ((sub_45bc9c(arg1, &var_70, "java/nio/charset/Charset") & 1) != 0)
                    result = 0
                else
                    x2_3 = var_70
                label_46fa74:
                    
                    if ((sub_45bc08(arg1, x0_2, x2_3, "java/nio/charset/Charset") & 1) != 0)
                        result = 0
                    else if (zx.d((*(*arg1 + 0x720))(arg1)) != 0)
                        result = 0
                    else
                        ...
                        if ((sub_45be5c(arg1, &var_78, &var_88, 1, 
                                "androidx/loader/app/services/d", "a", 
                                "(Ljava/lang/String;Ljava/nio/charset/Charset;)Ljava/lang/String;") & 1)
                                != 0)
                            result = 0
                        else
                            x2_4 = var_88
