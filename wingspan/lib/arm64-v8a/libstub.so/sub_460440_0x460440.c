...
if ((result & 1) == 0)
    ...
    if ((x0_5 & 0x80000000) == 0 && (result & 0xff) == 0)
        ...
        result = sub_45bc9c(arg1, &var_60, "android/view/View")
        
        if ((result & 1) == 0)
            x2_2 = var_60
        label_46056c:
            result = sub_45bc08(arg1, x0, x2_2, "android/view/View")
            ...
            if ((result & 1) == 0)
                ...
                if ((result & 0xff) == 0)
                    ...
                    result = sub_45bc9c(arg1, &var_68, "android/view/ViewOutlineProvider")
                    
                    if ((result & 1) == 0)
                        x2_3 = var_68
                    label_4605c0:
                        result = sub_45bc08(arg1, x0_2, x2_3, "android/view/ViewOutlineProvider")
                            ...
                            if ((result & 0xff) == 0)
                                if (x0 == 0)
                                    ...
                                    result = sub_45be5c(arg1, &var_60, &var_78, 0, 
                                        "android/view/View", "setOutlineProvider", 
