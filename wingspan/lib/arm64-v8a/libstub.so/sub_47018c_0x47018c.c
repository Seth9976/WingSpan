...
if ((sub_45be5c(arg1, &var_48, &var_58, 1, "androidx/loader/app/services/", &data_40bfc0, 0x452601)
        & 1) == 0)
    result = 0
    void var_40
    ...
    if ((*(*arg1 + 0x418))(arg1, var_48, var_58, &var_40) s>= 1
        ...
        if ((sub_45bc9c(arg1, &var_50, "android/content/res/Resources") & 1) != 0)
            result = 0
        else
            x2_2 = var_50
        label_470278:
            ...
            if ((sub_45bc08(arg1, x0, x2_2, "android/content/res/Resources") & 1) != 0)
                ...
                if ((sub_45be5c(arg1, &var_50, &var_60, 0, "android/content/res/Resources", 
                        "getDisplayMetrics", "()Landroid/util/DisplayMetrics;") & 1) != 0)
                    result = 0
                else
                    x2_3 = var_60
                label_470320:
