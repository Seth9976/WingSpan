...
if ((sub_45be5c(arg1, &var_48, &var_58, 1, "androidx/loader/app/services/", 0x4529be, 0x452601) & 1)
    ...
    if ((*(*arg1 + 0x418))(arg1, var_48, var_58, &var_40) s>= 1
        ...
        if ((sub_45bc9c(arg1, &var_50, "java/net/HttpURLConnection") & 1) != 0)
            result = 0
        else
            x2_2 = var_50
        label_471a14:
            ...
            if ((sub_45bc08(arg1, x0, x2_2, "java/net/HttpURLConnection") & 1) != 0)
                ...
                if ((sub_45be5c(arg1, &var_50, &var_60, 0, "java/net/HttpURLConnection", 
                        "getErrorStream", "()Ljava/io/InputStream;") & 1) != 0)
                    result = 0
                else
                    x2_3 = var_60
                label_471abc:
