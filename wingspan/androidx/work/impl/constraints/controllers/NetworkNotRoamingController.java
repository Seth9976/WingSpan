...
public final class NetworkNotRoamingController extends ConstraintController {
    @Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000E\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000E\u0010\u0003\u001A\u00020\u0004X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0005"}, d2 = {"Landroidx/work/impl/constraints/controllers/NetworkNotRoamingController$Companion;", "", "()V", "TAG", "", "work-runtime_release"}, k = 1, mv = {1, 7, 1}, xi = 0x30)
    ...
    static {
        ...
        NetworkNotRoamingController.TAG = "WM-NetworkNotRoamingCtr";
    }

    public NetworkNotRoamingController(ConstraintTracker constraintTracker0) {
    ...
    public boolean isConstrained(NetworkState networkState0) {
        ...
        if(Build.VERSION.SDK_INT < 24) {
            Logger.get().debug("WM-NetworkNotRoamingCtr", "Not-roaming network constraint is not supported before API 24, only checking for connected state.");
