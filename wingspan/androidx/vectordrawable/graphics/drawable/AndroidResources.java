...
class AndroidResources {
    ...
    static {
        AndroidResources.STYLEABLE_VECTOR_DRAWABLE_TYPE_ARRAY = new int[]{0x1010003, 0x1010121, 0x1010155, 0x1010159, 0x101031F, 0x10103EA, 0x10103FB, 0x1010402, 0x1010403};
        AndroidResources.STYLEABLE_VECTOR_DRAWABLE_GROUP = new int[]{0x1010003, 0x10101B5, 0x10101B6, 0x1010324, 0x1010325, 0x1010326, 0x101045A, 0x101045B};
        AndroidResources.STYLEABLE_VECTOR_DRAWABLE_PATH = new int[]{0x1010003, 0x1010404, 0x1010405, 0x1010406, 0x1010407, 0x1010408, 0x1010409, 0x101040A, 0x101040B, 0x101040C, 0x101040D, 0x10104CB, 0x10104CC, 0x101051E};
        AndroidResources.STYLEABLE_VECTOR_DRAWABLE_CLIP_PATH = new int[]{0x1010003, 0x1010405, 0x101051E};
        AndroidResources.STYLEABLE_ANIMATED_VECTOR_DRAWABLE = new int[]{0x1010199};
        AndroidResources.STYLEABLE_ANIMATED_VECTOR_DRAWABLE_TARGET = new int[]{0x1010003, 0x10101CD};
        AndroidResources.STYLEABLE_ANIMATOR = new int[]{0x1010141, 0x1010198, 0x10101BE, 0x10101BF, 0x10101C0, 0x10102DE, 0x10102DF, 0x10102E0};
        AndroidResources.STYLEABLE_ANIMATOR_SET = new int[]{0x10102E2};
        AndroidResources.STYLEABLE_PROPERTY_VALUES_HOLDER = new int[]{0x10102DE, 0x10102DF, 0x10102E0, 0x10102E1};
        AndroidResources.STYLEABLE_KEYFRAME = new int[]{0x1010024, 0x1010141, 0x10102E0, 0x10104D8};
        AndroidResources.STYLEABLE_PROPERTY_ANIMATOR = new int[]{0x10102E1, 0x1010405, 0x1010474, 0x1010475};
        AndroidResources.STYLEABLE_PATH_INTERPOLATOR = new int[]{0x10103FC, 0x10103FD, 0x10103FE, 0x10103FF, 0x1010405};
    }
}
